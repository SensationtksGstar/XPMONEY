  ...
  theme: {
    extend: {
      colors: {
        ...
        // ONE premium purple: `purple-*` re-anchored to the violet family so
        // every premium surface matches xp.purple / score.elite (#8b5cf6) —
        // same one-tone rule as green/emerald above.
        purple: {
          50:  '#f5f3ff',
          100: '#ede9fe',
          200: '#ddd6fe',
